  ...
  function getIconHtml(item) {
    ...
    if (item.type === 'login') {
      ...
      if (domain) {
        ...
        // Dual CDN Fallback: Clearbit (High-res) -> DuckDuckGo (strict 404) -> Default Globe
        iconHtml = `<img src="https://logo.clearbit.com/${domain}" style="width:75%; height:75%; object-fit:contain; border-radius:6px; filter:drop-shadow(0 2px 4px rgba(0,0,0,0.25));" onerror="if(this.src.includes('clearbit')){this.src='https://icons.duckduckgo.com/ip3/${domain}.ico';}else{this.outerHTML='<i class=\\'fa-solid fa-globe\\'></i>';}">`;
      }
    }
    return iconHtml;
  }
