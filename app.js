...
(function () {
  ...
  // --- NOTION VISUAL ICON PICKER DATASET (120+ ICONS) ---
  const CATEGORY_ICONS = [
    // Work & Business
    { id: 'fa-folder', name: 'Folder', tags: 'general file directory' },
    { id: 'fa-briefcase', name: 'Work', tags: 'office job business' },
    { id: 'fa-building', name: 'Company', tags: 'corporate office building' },
    { id: 'fa-store', name: 'Store', tags: 'shop vendor merchant' },
    { id: 'fa-shop', name: 'Shop', tags: 'retail store market' },
    { id: 'fa-address-card', name: 'ID Card', tags: 'identity card profile' },
    { id: 'fa-user-gear', name: 'Admin', tags: 'manager account setting' },
    { id: 'fa-people-group', name: 'Team', tags: 'group hr staff' },
    { id: 'fa-handshake', name: 'Deals', tags: 'partner contract agreement' },
    { id: 'fa-chart-line', name: 'Growth', tags: 'analytics stocks chart' },
    { id: 'fa-chart-pie', name: 'Reports', tags: 'pie chart metrics' },
    { id: 'fa-stamp', name: 'Official', tags: 'stamp approved legal' },
    { id: 'fa-signature', name: 'Contracts', tags: 'sign agreement doc' },
    ...
    { id: 'fa-code-branch', name: 'Git', tags: 'github branch repo' },
    { id: 'fa-cube', name: 'Module', tags: 'docker container package' },
    { id: 'fa-cubes', name: 'K8s', tags: 'kubernetes microservice' },
    { id: 'fa-bug', name: 'Bugs', tags: 'qa debug error test' },
    { id: 'fa-robot', name: 'AI Bot', tags: 'ai bot gpt chat' },
    { id: 'fa-microchip', name: 'Hardware', tags: 'cpu chip hardware' },
    { id: 'fa-wifi', name: 'WiFi', tags: 'internet network connection' },
    ...
    { id: 'fa-user-shield', name: 'User Shield', tags: 'account identity protection' },
    { id: 'fa-fingerprint', name: 'Biometrics', tags: 'fingerprint touchid auth' },
    { id: 'fa-passport', name: 'Passport', tags: 'govt doc visa ID' },
    { id: 'fa-file-contract', name: 'Legal', tags: 'doc agreement legal' },
    { id: 'fa-file-shield', name: 'Encrypted Doc', tags: 'secure file PDF' },
    { id: 'fa-vault', name: 'Vault', tags: 'master safe secret' },
    ...
    { id: 'fa-piggy-bank', name: 'Savings', tags: 'deposit money save' },
    { id: 'fa-money-bill-wave', name: 'Cash', tags: 'currency dollar money' },
    { id: 'fa-sack-dollar', name: 'Assets', tags: 'investment wealth finance' },
    { id: 'fa-receipt', name: 'Bills', tags: 'invoice receipt tax' },
    { id: 'fa-scale-balanced', name: 'Audit', tags: 'tax audit legal' },

    // Gaming & Entertainment
    { id: 'fa-gamepad', name: 'Gaming', tags: 'game steam play console' },
    { id: 'fa-dice-d20', name: 'RPG', tags: 'game board dice' },
    { id: 'fa-vr-cardboard', name: 'VR', tags: 'ar 3d gaming headset' },
    { id: 'fa-headset', name: 'Headset', tags: 'discord voice gaming' },
    { id: 'fa-trophy', name: 'Trophy', tags: 'rank win award' },
    { id: 'fa-chess', name: 'Chess', tags: 'strategy game mind' },

    // Media, Music & Video
    { id: 'fa-film', name: 'Movies', tags: 'cinema tv stream' },
    { id: 'fa-tv', name: 'TV', tags: 'netflix display monitor' },
    { id: 'fa-video', name: 'Video', tags: 'youtube netflix media' },
    { id: 'fa-music', name: 'Music', tags: 'spotify audio song' },
    { id: 'fa-headphones', name: 'Audio', tags: 'podcast music listen' },
    { id: 'fa-camera', name: 'Photos', tags: 'image pic media' },
    { id: 'fa-newspaper', name: 'News', tags: 'article paper press' },
    { id: 'fa-book', name: 'Books', tags: 'reading study ebook' },

    // Travel, Transport & Places
    { id: 'fa-plane', name: 'Travel', tags: 'flight hotel vacation trip' },
    { id: 'fa-car', name: 'Car', tags: 'auto drive vehicle' },
    { id: 'fa-motorcycle', name: 'Bike', tags: 'scooter ride moto' },
    { id: 'fa-train', name: 'Train', tags: 'metro transit commute' },
    { id: 'fa-hotel', name: 'Hotel', tags: 'stay resort resort' },
    { id: 'fa-compass', name: 'Explore', tags: 'map navigate location' },
    { id: 'fa-anchor', name: 'Maritime', tags: 'ship sea cruise' },
    { id: 'fa-umbrella-beach', name: 'Vacation', tags: 'beach holiday sun' },

    // Shopping, Food & Lifestyle
    { id: 'fa-cart-shopping', name: 'Shopping', tags: 'store buy amazon shop' },
    { id: 'fa-basket-shopping', name: 'Groceries', tags: 'food market store' },
    { id: 'fa-bag-shopping', name: 'Fashion', tags: 'clothes shopping retail' },
    { id: 'fa-gift', name: 'Rewards', tags: 'present coupon bonus' },
    { id: 'fa-tag', name: 'Coupons', tags: 'discount label offer' },
    { id: 'fa-utensils', name: 'Food', tags: 'restaurant dinner cafe' },
    { id: 'fa-mug-hot', name: 'Coffee', tags: 'daily cafe break' },
    { id: 'fa-pizza-slice', name: 'Takeout', tags: 'fastfood pizza order' },
    { id: 'fa-wine-glass', name: 'Drinks', tags: 'bar party nightlife' },
    ...
    { id: 'fa-dumbbell', name: 'Gym', tags: 'fitness workout sport' },
    { id: 'fa-person-running', name: 'Sports', tags: 'running exercise track' },
    { id: 'fa-hospital', name: 'Medical', tags: 'health doctor insurance' },
    { id: 'fa-pills', name: 'Meds', tags: 'pharmacy medicine health' },
    ...
    { id: 'fa-fire', name: 'Hot', tags: 'trending popular hot' },
    ...
    { id: 'fa-paperclip', name: 'File', tags: 'attachment doc pdf' },
    { id: 'fa-sliders', name: 'Filters', tags: 'settings config controls' },
